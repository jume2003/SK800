...
{
    public interface IJudgerParamerService
    {
        ...
        bool InsertT_JudgeParamer(IList<T_JudgeParamer> t_JudgeParamerList);
        bool UpdateT_JudgeParamer(IList<T_JudgeParamer> t_JudgeParamerList);
